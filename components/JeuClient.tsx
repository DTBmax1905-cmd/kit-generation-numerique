...
export default function JeuClient({ jeu }: { jeu: Jeu | null }) {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-64px)]">
      <div className="bg-white border-b border-gray-100 px-4 py-2.5 flex items-center justify-between flex-shrink-0">
        ...
        <a href={jeu.url} target="_blank" rel="noopener noreferrer"
      ...
      {!iframeError ? (
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-4 px-4 text-center bg-gray-50">
          ...
          <p className="text-gray-500 text-sm max-w-xs">
            Ce jeu ne peut pas s&apos;afficher ici. Cliquez ci-dessous pour y jouer.
          </p>
          <a href={jeu.url} target="_blank" rel="noopener noreferrer" className="btn-primary">
